						...
						<table cellspacing="0" align="center" width="600" cellpadding="0">
							<tr>
								<td class="header-text" align="center" style="color: #FFF; font-family: Verdana; font-size: 10px; text-transform: uppercase; padding: 0 20px;">
									<br /><a href="http://photostream.com" style="color: #00ffff; text-decoration: none;"> PhotoStream.com is your repository for all of your photos on the major social networks. Create streams and enjoy it publicly or privately with friends.
								</td>
							</tr>
						</table>
					</td>
						...
						<table cellspacing="0" align="center" width="600" cellpadding="0">
							<tr>
								<td class="main-title" style="padding: 0 20px; font-size: 28px; text-align: center; font-family: Georgia; text-transform: uppercase; letter-spacing: 6px;">
									<br /><img src="http://www.beta.photostream.com/img/logo-photostream.png" width="500" height="90" />
								</td>
							</tr>
						</table>
					</td>
			...
			<table cellspacing="0" width="100%" cellpadding="0">
				<tr>
					<td valign="top">
						<!-- footer -->
						<br />
						<!--table cellspacing="0" border="0" align="center" height="100" cellpadding="0" width="600">
							<tr>
								<td valign="top">
									<table cellspacing="0" border="0" width="600" cellpadding="0">
										<tr>
											<td class="unsubscribe" valign="top" style="padding: 20px; color: #999; font-size: 14px; font-family: Georgia; line-height: 20px; text-align: center;" width="600">
												You received this email because at some point in the past you either bought one of our products, signed 
												up to our mailing list, or drunk some of that "special" tea we slipped you. If you'd like, you can 
												<a href="#" style="color: #cc0000; text-decoration: none;">unsubscribe</a>.
											</td>
										</tr>
									</table>
								</td>
					...
					<td valign="top" bgcolor="#484845">
						<table cellpadding="0" cellspacing="0" width="600" align="center" style="color:#555;font-family:Arial,sans-serif;font-size:12px;line-height:22px;padding:10px;color:white">
									<tbody>
										...
										<td width="80"><a style="color:white;text-decoration:none" href="http://www.facebook.com/pages/PhotoStreamcom/283878414986443">Facebook</a> </td>
										<td width="35"><img src="http://domaindirectory.com/servicepage/images/twitter.png" width="24" height="24" border="0" alt=""></td>
										<td width="80"><a style="color:white;text-decoration:none" href="https://twitter.com/#!/PhotoStreamcom">Twitter</a> </td>
										<td width="35"><img src="http://domaindirectory.com/servicepage/images/contact.png" width="24" height="24" border="0" alt=""></td>
										<td width="90"><a style="color:white;text-decoration:none" href="http://www.photostream.com/info/contact_us">Contact Us</a></td>
										</tr>
									</tbody>
								</table>
					</td>
