										...
										<div class="grid" id="<?=$stream->stream_id?>">
												<div class="photohover" id="hover<?=$stream->stream_id?>">
														...
														<a href="#edit_stream_info" data-toggle="modal" id="<?=$stream->stream_id?>" class="edit" title="edit stream" style="font-size: 16px;color:rgb(71, 248, 127);">
															...
															<br>
														<a href="#" class="albumpics" style="color:rgb(71, 174, 255);text-decoration:none">
												...
												<div class="meta">
													...
													<a href="<?=base_url()?>stream/album/<?=($stream->title=='')?'&nbsp;':url_title($stream->title)?>/<?=$stream->stream_id?>" style="text-decoration:none"><?=($stream->title=='')?'&nbsp;':$stream->title?></a>
											</div>										
									</div>
									<? endforeach; ?>
								</div>
