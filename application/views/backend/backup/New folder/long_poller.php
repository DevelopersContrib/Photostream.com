...
<?php $this->load->view('backend/navigation')?>
    ...
    function addmsg(type, msg,img,lname,fname,username,title,pcount){
        ...
        $("#newsFeed-ul").append(
            "<li><div class='media'><a class='pull-left' href=''><img style='width:30px;height:30px;' src='"+img+"' alt='' /></a><div class='media-body'><a class='a-feed' href='/"+username+"'><b>"+fname+" "+lname+"  </b><span class='info-feed'>"+myarr[0]+" "+pcount+" photos "+myarr[2]+" "+myarr[3]+"  in Album "+title+" </span></a></div></div></li>"
        );
    }
