		...
		<div class="span12">      		
      		...
      		<div class="widget stacked ">
				...
				<div class="widget-content">
					<?if($this->session->userdata('instagram-token') || $this->session->userdata('access_token')):?>
						...
						<div style="width:100%;margin-bottom: 20px;">
							<div style=" text-align: left; display: inline-block; width: 50%;">
								<span style="font-size: 25px;">Photos from Instagram </span><br>
					...
					<?else:?>
						<p>Come on</p>
						<?php echo anchor($this->instagram_api->instagramLogin(), 'login through Instagram'); ?>
					<?endif;?>
				</div>
...
<script type="text/javascript">
	...
	$('#addstream').click(function(){
		...
		if(selected_pics.length <= 0){
				...
				$.post('/stream/save_instagram_pics',{selected_pics:selected_pics,counter:counter},function(data){
