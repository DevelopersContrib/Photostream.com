											...
											<div class="row-fluid">
												<div class="wrap-user-title">
													...
													<div style="padding: 3px 0 3px 0;">
														<h3 style="margin: 0;margin-top:2px;display:inherit;line-height: 15px;top:2px;font-size: 18px;"><a href="<?=base_url()?>stream/album/<?=$stream_id?>" style="text-decoration:none;"><?=$stream_title?></a></h3>
