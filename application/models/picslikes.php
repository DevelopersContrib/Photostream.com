<?php
class PicsLikes extends CI_Model {
	private $table = "photo_pics_likes";
	private $pk = "like_id";
	private $date = null;
  ...
  function deletelike($field1,$field2,$value1,$value2){  	return $this->db->query("DELETE FROM `$this->table` where `$field1` = '".$value1."' AND `$field2` = '".$value2."'");    }
