<?php
class PhotoCountry extends CI_Model {
	private $table = "photo_country";
	private $pk = "country_id";
	private $date = null;
	...
	{
		$query = $this->db->query("SELECT * FROM `$this->table` ORDER BY country_name ASC");
		return $query->result();
	}
